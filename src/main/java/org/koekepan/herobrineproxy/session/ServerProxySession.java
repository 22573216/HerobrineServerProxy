...
public class ServerProxySession implements IProxySessionNew {
	...
	public ServerProxySession(Socket socket, String serverHost, int serverPort) {
		ConsoleIO.println("PROXY INIT");
...
//		this.clientSession.setPacketBehaviours(clientPacketBehaviours);
	...
	public void setUsername(String username) {
		ConsoleIO.println("PROXY SET USERNAME");
...
//		clientSession.sendPacket(packet);
		ConsoleIO.println("SEND PACKET TO CLIENT");
	}
	...
	public void connect(String host, int port) {
		ConsoleIO.println("PROXY CONNECT");
